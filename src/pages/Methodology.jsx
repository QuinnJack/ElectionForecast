    ...
    <div>
      ...
      <div className="font-sans p-8 relative max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <br />
          <h3 className="text-4xl font-semibold text-left font-editorial text-gray-800">
            Polling Sources
          </h3>
          <br />
          <p className="text-left font-mono text-gray-600">
          ...
          <br />
          <h2 className="text-5xl font-semibold text-left font-editorial text-gray-800">
            Model Construction
          </h2>
          <br />
          <p className="text-left font-mono text-gray-600">
        ...
        >
          <defs>
            ...
            <style>
              {
                "@keyframes eaf-2f5c-2{0%{animation-timing-function:step-start}7.34%{stroke-dashoffset:100;animation-timing-function:ease}47.68%,to{stroke-dashoffset:0}}#eaf-2f5c-0 *{animation:5000ms linear 1 normal both running;offset-rotate:0deg}"
              }
            </style>
          </defs>
          <g
