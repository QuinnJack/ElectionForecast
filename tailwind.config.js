  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: ({ theme }) => ({
        ...
        lg: `0px 4px 8px -2px ${theme(
          "colors.neutral.900/5%"
        )}, 0px 5px 10px ${theme("colors.neutral.900/8%")}`,
        xl: `0px 20px 24px -4px ${theme(
          "colors.neutral.900/10%"
        )}, 0px 8px 8px -4px ${theme("colors.neutral.900/4%")}`,
      }),
      spacing: {
        4.5: "1.125rem",
        5.5: "1.375rem",
